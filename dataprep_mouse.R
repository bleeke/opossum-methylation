# 20210317
# BJL
# dataprep mouse control BS-seq data
...
# directories
dataDir <- "/camp/lab/turnerj/working/Bryony/manuscript/analysis/data/mouse_bsseq/methyl_extract/bismark_CpG_report"
sampleDir <- "/camp/lab/turnerj/working/Bryony/manuscript/analysis/data/"
outDir <- "/camp/lab/turnerj/working/Bryony/manuscript/analysis/data/mouse_bsseq/methylKit_out"

# import sample metadata
setwd(sampleDir)
sample_data <- read_delim("mouse_sample_data.txt", delim = "\t") %>%
